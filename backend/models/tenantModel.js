...
const tenantSchema = new mongoose.Schema({
  ...
  moveOutDateRequested: { type: Date, default: null },
  moveOutNoticeDays: { type: Number, default: 0 },
  moveOutFineApplied: { type: Number, default: 0 },
  moveOutFineRemainingPayable: { type: Number, default: 0 },
