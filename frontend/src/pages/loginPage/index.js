...
const Login = () => {
  ...
  const images = ["/images/aboutImages/aboutIMG1.png", "/images/loginImages/loginImg1.jpg", "/images/loginImages/loginImg2.jpg"];
  ...
  const handleLoginClick = () => {
    ...
    let hasError = false;
    if (!email || !validateEmail(email)) { newErrors.email = "Valid email required"; hasError = true; }
    if (!password || password.length < 6) { newErrors.password = "Min 6 characters required"; hasError = true; }
      ...
      <div className="hidden lg:block">
        {images.map((img, i) => (
          <div key={i} className="absolute inset-0 transition-opacity duration-1000"
            style={{ backgroundImage: `url(${img})`, backgroundSize: "cover", backgroundPosition: "center", opacity: i === currentImage ? 1 : 0 }} />
        ))}
      </div>
 
      <div className="relative z-10 w-full px-4 lg:ml-20 flex justify-center lg:justify-start">
        <CFormCard className="relative bg-white p-4 sm:p-6 rounded-xl shadow-xl border-2 border-primary w-full max-w-[340px] lg:max-w-[500px] animate-fadeIn">
          ...
          <div className="flex gap-2 mb-4">
            <CButton fullWidth className="text-sm" variant={role === "user" ? "contained" : "outlined"} onClick={() => setRole("user")}>User</CButton>
          ...
          {/* Updated Checkbox size container */}
          <div className="flex justify-between items-center text-xs mt-4">
            ...
            />
            <a href="/forgot-password" style={{ color: "#D97706" }} className="text-xs hover:underline">Forgot Password?</a>
          </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          <div className="relative bg-white w-full max-w-[360px] rounded-2xl shadow-2xl p-6 animate-slideUp">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              {/* RECAPTCHA SCALE REDUCED */}
              <div className="scale-[0.85] sm:scale-90 origin-center transition-transform">
                <ReCAPTCHA
