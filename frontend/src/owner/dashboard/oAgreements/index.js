    ...
    */
    <div className="h-screen w-full bg-gray-100 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-orange-100 rounded-lg">
              <FaFileContract className="text-orange-500 text-2xl md:text-3xl" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Agreements</h1>
        ...
        {/* SEARCH SECTION */}
        <div className="bg-white p-4 md:p-5 rounded-xl border-t-4 border-t-primary shadow-sm flex flex-col md:flex-row gap-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm min-w-[900px]">
              <thead className="bg-orange-50 border-b border-orange-100">
                <tr className="text-gray-700 text-xs uppercase font-bold">
